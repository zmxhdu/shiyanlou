...
config_filename='E:/Python/shiyanlou/test.cfg'
user_filename='E:/Python/shiyanlou/user.csv'
result_filename='E:/Python/shiyanlou/gongzi.csv'
...
def calculator():
    ...
    for lines in user_file:
        ...
        result.put(user_num, user_salary, JiShu * premium, ratal * rate - deduction, real_salary)
...
def main():
    userdata=UserData()
    Process(target=userdata.get_user()).start()
